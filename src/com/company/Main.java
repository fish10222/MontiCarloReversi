...
public class Main extends JPanel implements MouseListener{
    ...
    static int HeuristicTotalScore = 0;
    static int MCTSTotalScore = 0;
    // {Heuristic Wins, MCTS Wins, Ties}
    static int[] stats = {0, 0, 0};
    static double MCTS_running_Time = 0;
    static double Heuristics_running_Time = 0;
    static double MCTS_moves = 0;
    static double Heuristics_moves = 0;
